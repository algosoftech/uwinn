...
class Usersagreement extends CI_Controller {
	...
	public function index()
	{
       ...
       if ($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('Users Agreement | CMS | UWINN');
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']		=	$this->common_model->getDataByParticularField('uw_cms','usersagreement_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')): 
			...
			if($this->form_validation->run() && $error == 'NO'):  
				...
				if($this->input->post('CurrentDataID') ==''):
					$param['usersagreement_id']		=	(int)$this->common_model->getNextSequence('uw_cms');
					...
					$this->common_model->editData('uw_cms',$param,'usersagreement_id',(int)$NotificationTempId);
		...
		$this->layouts->set_title('Add/Edit Users Agreement_id | CMS | UWINN');
	...
	{  
		...
		$this->common_model->editData('uw_cms',$param,'usersagreement_id',(int)$changeStatusId);
