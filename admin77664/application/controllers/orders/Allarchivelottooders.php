...
class Allarchivelottooders extends CI_Controller {
	...
	{	
		...
		$data['activeSubMenu'] 				= 	'allarchivelottooders';
		...
		$tblName 							= 	'uw_lotto_orders_archives';
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$resultType  			= '';
		$tblName 	  		    = 'uw_lotto_orders_archives';
		$data['ALLDATA']  		= $this->common_model->getOrderDetails($resultType,$whereCondition,$startIndex,$itemsPerPage,$tblName);
		// echo "<pre>";print_r($data);die();

		$this->layouts->set_title('Orders | UWINN');
		$this->layouts->admin_view('orders/allarchivelottooders/index',array(),$data);
	}	// END OF FUNCTION
	...
	{		
		...
		if($editId):
			$data['orderData']	  =	$this->common_model->getDataByParticularField('uw_lotto_orders_archives','order_id',$editId);
		...
		$this->layouts->set_title('Orders | UWINN');
		$this->layouts->admin_view('orders/allarchivelottooders/addeditdata',array(),$data);
	}	// END OF FUNCTION	
	...
	************************************************************************/
	...
	{  
		...
		if($cancleOrderData['status']  == 'CL'):
			...
			$this->common_model->editData('uw_lotto_orders_archives',$param1,'order_id',$changeStatusId);
	...
	************************************************************************/
	...
	{	
		...
		$this->layouts->admin_view('orders/allarchivelottooders/exportexcel',array(),$data);
	}	// END OF FUNCTION
	...
	************************************************************************/
	public function generatecoupons()
	{
		...
		$data['orderData'] 				=	$this->common_model->getData('single', 'uw_lotto_orders_archives', $wcon);
