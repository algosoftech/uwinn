...
class Upload_winners extends CI_Controller {
	...
	{	
		...
		$data['activeSubMenu'] 				= 	'upload_winners';
	...
	public function addeditdata($bid='')
 	{	
		...
		if(empty($bid)):
			...
			redirect(correctLink('UPLOADVOUCHERDATA',getCurrentControllerPath('index')));
		endif;
		...
		$this->session->set_userdata('UPLOADVOUCHERDATA',currentFullUrl());
