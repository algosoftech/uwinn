...
class AllWinners extends CI_Controller {
	...
	{	
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('Winner List | UWINN');
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']				=	$this->common_model->getDataByParticularField('uw_uwin_testimonials','testimonial_id',(int)$editId);
		else:
		...
		if($this->input->post('SaveChanges')):
			...
			if($this->input->post('CurrentDataID') ==''):
				...
				$param['status']			=	'A';
				$alastInsertId				=	$this->common_model->addData('uw_uwin_testimonials',$param);
				...
				$this->common_model->editData('uw_uwin_testimonials',$param,'testimonial_id',(int)$SEQId);
				$this->session->set_flashdata('alert_success',lang('updatesuccess'));
			endif;
			redirect(correctLink('CMSTESTIMONIALS',getCurrentControllerPath('index')));
		endif;
		
		$this->layouts->set_title('Add/Edit Terms & conditions | UWINN');
	...
	{  
		...
		$this->common_model->editData('uw_uwin_testimonials',$param,'testimonial_id',(int)$changeStatusId);
	...
	{  	
		if($deleteId):
			$this->admin_model->authCheck('edit_data');
			$data			=	$this->common_model->getDataByParticularField('uw_uwin_testimonials','testimonial_id',(int)$deleteId);
		...
		$this->common_model->deleteData('uw_uwin_testimonials','testimonial_id',(int)$deleteId);
	...
	************************************************************************/
	...
	{  
		...
		if($imageName):
			...
			$this->common_model->editData('uw_uwin_testimonials',$param,'testimonial_id',(int)$id);
		endif;
		if($typ == 'web'):
