...
class Registration extends CI_Controller {
	...
	{	
		...
		$data['ALLDATA']['total_urser']		=	$this->common_model->getRegistrationStatistics($whereCon);
		...
		if($this->input->get()){
			...
			if($this->input->get('email')){
				if($this->input->get('shortBy') == 'Admin' || $this->input->get('shortBy') == 'Sub Admin'):
					...
					$user_details 			= 	$this->common_model->getData('single', 'da_users', array('where'=> array('users_email' => $data['email'])));
					$user_data	=	array(
