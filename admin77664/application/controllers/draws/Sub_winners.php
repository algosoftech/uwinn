...
class Sub_winners extends CI_Controller {
	...
	{	
		...
		$data['activeSubMenu'] 				= 	'sub_winners';
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('All SubWinners | Winners | Dealz Arabia');
		$this->layouts->admin_view('subwinners/index',array(),$data);
	}	// END OF FUNCTION
