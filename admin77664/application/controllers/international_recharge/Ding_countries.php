...
class Ding_countries extends CI_Controller {
	...
	{	
		...
		$shortField 						= 	array('country_name'=>1);
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('All country code list | Ding |International Recharge | Instwin');
		$this->layouts->admin_view('international_recharge/ding/countrycode/index',array(),$data);
	}	// END OF FUNCTION
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->editData('ding_country_list',$param,'_id', new MongoDB\BSON\ObjectID($changeStatusId));
		$this->session->set_flashdata('alert_success',lang('statussuccess'));
		
		redirect(correctLink('ALLDINGCOUNTRYDATA',getCurrentControllerPath('index')));
	}
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->deleteData('ding_country_list','_id', new MongoDB\BSON\ObjectID($deleteId));
	...
	************************************************************************/
	...
	{	
		...
		$this->layouts->set_title('Export CSV | Ding Country Code List | International Recharge | Inswin');
		$this->layouts->admin_view('international_recharge/ding/countrycode/exportexcel',array(),$data);
	}	// END OF FUNCTION
	...
	************************************************************************/
	function exportexcelApi(){
		...
		// $page = 1;
 		$itemsPerPage = 5000;
 		$startIndex  = ($page - 1)*$itemsPerPage;
 		$shortField  = array('CountryName' => 1);
 		$resultType  = '';
		$tblName     = "ding_country_list";
		...
		foreach($OrderData as $index => $itemsArray):
			...
			$CSVData1['Country Name']      = !empty($itemsArray['CountryName']) ? $itemsArray['CountryName'] : 'N/A';
