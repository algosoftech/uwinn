...
class Ding_regions extends CI_Controller {
	...
	{	
		...
		$this->session->set_userdata('ALLDINGREGIONDATA',currentFullUrl());
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('All region list | Ding |International Recharge | Instwin');
		$this->layouts->admin_view('international_recharge/ding/region/index',array(),$data);
	}	// END OF FUNCTION
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->editData('ding_region_list',$param,'_id', new MongoDB\BSON\ObjectID($changeStatusId));
		$this->session->set_flashdata('alert_success',lang('statussuccess'));
		
		redirect(correctLink('ALLDINGREGIONDATA',getCurrentControllerPath('index')));
	}
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->deleteData('ding_region_list','_id', new MongoDB\BSON\ObjectID($deleteId));
