...
class Ding_products extends CI_Controller {
	...
	{	
		...
		$data['activeSubMenu'] 				= 'Ding_products';
		...
		$this->session->set_userdata('ALLDINGPRODUCTSDATA',currentFullUrl());
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('All product list | Ding |International Recharge | Instwin');
		$this->layouts->admin_view('international_recharge/ding/product/index',array(),$data);
	}	// END OF FUNCTION
	...
	************************************************************************/
	function addeditdata($editId='')
	{
		...
		try{
			...
			$this->session->set_flashdata('alert_error','Invalid product id.');
		...
		if(empty($data['EDITDATA'])):
			$this->session->set_flashdata('alert_error','Product data not found.');
			redirect(getCurrentControllerPath('index'));
		endif;
		...
		if($this->input->post('SaveChanges')):
			...
			if($this->form_validation->run() && $error == 'NO'):
				...
				redirect(correctLink('ALLDINGPRODUCTSDATA',getCurrentControllerPath('index')));
			endif;
		endif;
		$this->layouts->set_title('Edit Ding Product | International Recharge | Instwin');
		$this->layouts->admin_view('international_recharge/ding/product/addeditdata',array(),$data);
	}
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->editData('ding_products_list',$param,'_id', new MongoDB\BSON\ObjectID($changeStatusId));
	...
	************************************************************************/
	...
	{  
		...
		$this->common_model->deleteData('ding_products_list','_id', new MongoDB\BSON\ObjectID($deleteId));
