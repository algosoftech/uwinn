...
class Allcategory extends CI_Controller {
	...
	{	
       ...
       if($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('Category | Category | UWINN');
	...
	{		
		...
		if($editId):
			...
			$data['EDITDATA']				=	$this->common_model->getDataByParticularField('uw_category','category_id',(int)$editId);//echo '<pre>';print_r($data['EDITDATA']);die;
		else:
		...
		if($this->input->post('SaveChanges')):
			...
			if($this->form_validation->run() && $error == 'NO'): 
				...
				if($this->input->post('CurrentDataID') ==''):
					$param['category_id']		=	(int)$this->common_model->getNextSequence('uw_category');
					...
					if($check == 0):
						$alastInsertId				=	$this->common_model->addData('uw_category',$param);
					...
					$this->common_model->editData('uw_category',$param,'category_id',(int)$categoryId);
		...
		$this->layouts->set_title('Add/Edit Category | Category | UWINN');
	...
	************************************************************************/
	...
	{  
		...
		if($imageName):
			...
			$this->common_model->editData('uw_category',$param,'category_id',(int)$id);
		endif;
		if($typ == 'web'):
