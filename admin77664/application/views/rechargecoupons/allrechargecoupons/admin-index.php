              ...
              <div class="table-responsive">
                <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                  <thead style="text-align: center;">
                    ...
                    <th width="5%" style="text-align: center;">Batch Id</th>
                    <th width="20%">Generated For</th>
                  ...
                  <tbody style="text-align: center;">
                    ...
                    <tr role="row" class="<?php echo $rowClass; ?>">
                      ...
                      <td><?=substr($ALLDATAINFO['batch_id'], -5);?>  </td>
                      <td>
                        <?php if($ALLDATAINFO['generate_for']): ?>
                         <br/> <b>Voucher Count :</b> <?=stripslashes($ALLDATAINFO['batch_count'])?>
                         <br/> <b>Generated For :</b> <?=stripslashes($ALLDATAINFO['generate_for'])?>
                        <?php endif;?> 
                        <br/> <b>coupon Code :</b> <?=$ALLDATAINFO['first_coupon_code'].' - '.$ALLDATAINFO['last_coupon_code'];?>
                        <br>  <b>Date :</b> <?=$this->timezone->location_date($ALLDATAINFO['created_date'],'d F Y H:i',DEFAULT_TIMEZONE);?>
                      </td>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <li><a href="<?php echo base_url('recharge/allrechargevoucher/index/'.$ALLDATAINFO['batch_id'])?>"><i class="fas fa-eye"></i> View Vouchers</a></li>
                          <?php if($ALLDATAINFO['status'] == 'A'): ?>
                            <li><a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['batch_id'].'/I')?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
                          <?php elseif($ALLDATAINFO['status'] == 'I'): ?>
                            <li><a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['batch_id'].'/A')?>"><i class="fas fa-thumbs-up"></i> Active</a></li>
                          <?php endif; ?>
                            <li><a href="<?php echo getCurrentControllerPath('deletedata/'.$ALLDATAINFO['batch_id'])?>" onClick="return confirm('Want to delete!');"><i class="fas fa-trash"></i> Delete</a></li>
                           </ul>
                        </div>
                      </td>
                    </tr>
