...
<script>
    ...
    var draw_one          = <?=json_encode($draw_one);?>;
    var draw_two          = <?=json_encode($draw_two);?>;
    ...
    function GETDATA() {
        if (currentPage <= totalPage ) {
            $.ajax({
                ...
                type: 'POST',
                data: { pageno: currentPage, searchField: searchField, searchValue: searchValue, fromDate: fromDate, toDate: toDate , cancelled_order :cancelled_order, draw_time_one : draw_one, draw_time_two : draw_two,  productIds : productIds },
