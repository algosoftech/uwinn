            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Cash Vouchers</a></li>
                    </ul>
                </div>
            </div>
        </div>
                       ...
                       <div class="row">
                        ...
                        <div class="col-sm-3 col-md-3">
                          <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
                            ...
                            <option value="generated_by" <?php if($searchField == 'generated_by')echo 'selected="selected"'; ?>>Created By( Email / Mobile Number ) </option>
                            <option value="redeemed_by"  <?php if($searchField == 'redeemed_by')echo 'selected="selected"'; ?>>Redeemed By ( Mobile , POS Device Id )</option>
                            <option value="status"       <?php if($searchField == 'status')echo 'selected="selected"'; ?>>Status (A = Active , I = Inavtive, C = Completed, CL = Cancelled)</option>
                          </select>
                        </div>
                              ...
                              <tbody style="text-align: center;">
                                ...
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <td>
                                      ...
                                      <br> <b> Verification Code :-  </b> <?=$ALLDATAINFO['verification_code'];?>
                                      <br> <b> UPoints :-            </b> <?=$ALLDATAINFO['amount'] ." AED";?>
                                  </td>
                                  <td>
                                    <?php
                                        $tblName           = 'uw_users';
                                        $whereCon['where'] = array('users_id' => (int)$ALLDATAINFO['created_by']);
                                        $Files             = array('users_mobile','users_email','pos_device_id','store_name','users_type','users_name','last_name');
                                        $UsersData         = $this->common_model->getParticularFieldByMultipleCondition($Files,$tblName , $whereCon);
                                          
                                        $full_name        = $UsersData['users_name'].' '.$UsersData['last_name'];
                                        $users_email      = $UsersData['users_email'];
                                        $phone            = $UsersData['users_mobile'];
                                        $created_by       = $UsersData['users_type'];
                                        $pos_device_id    = $UsersData['pos_device_id'];
                                    ?>
                                    <br> <b>Name        :- </b> <?=$full_name;?>
                                    <br> <b>Email       :- </b> <?=$users_email;?>
                                    <br> <b>Mobile      :- </b> <?=$phone;?>
                                  ...
                                  <td>
                                      <?php 
                                          $UsersData1 = [];
                                          if($ALLDATAINFO['status'] == "C"):

                                            $tblName             = 'uw_users';
                                            $whereCon22['where'] = array('users_id' => (int)$ALLDATAINFO['seller_id']);
                                      ...
                                      if($UsersData1):  ?>
                                        <br> <b>POS device Id  :-  </b> <?=$pos_number;?>
                                        <br> <b>Mobile         :-  </b> <?=$phone;?>
                                        <br> <b>Redeeming date :-  </b> <?=$ALLDATAINFO['update_date'];?>
                                      <?php else:?>     
                                          --
                                      <?php endif;?>     
                                  ...
                                  <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                      ...
                                      <li><a href="<?php echo getCurrentControllerPath('cancellation/'.$ALLDATAINFO['_id']->{'$id'})?>" onClick="return confirm('Do you want to cancel!');"><i class="fas fa-trash"></i> Cancel</a></li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Download Cash Voucher Coupons</h5>
