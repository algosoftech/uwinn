                                ...
                                <div class="col-sm-12 col-sm-offset-12">
                                    <table style="width: 100%">
                                        <thead>
                                            ...
                                            <tr>
                                                <td class="text-left" colspan="7"><span class="order-deatils">Raffle Coupons :</span>
                                                    <?php

                                                    if($orderData['raffle_tickets']):
                                                       
                                                        $Tickect =  implode(', ', $orderData['raffle_tickets'] ); ?>
                                                        <div class="coupon-container">
                                                            <span class="coupon-code-circled"><?=$Tickect;?></span> 
                                                        </div>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        ...
                                        <tbody>    
                                            <tr>
                                                ...
                                                <th style="text-align:center;">POS Device ID </th>
                                            ...
                                            <tr>
                                                <td width="20%"><?php echo $orderData['product_title']; ?></td>
                                                <td width="20%"><?php echo $orderData['pos_device_id']; ?></td>
                                                <!-- <td width="5%"><?php echo $orderData['product_is_donate']=='Y'?'Yes':'No'; ?></td> -->

                                                <td width="10%"><?=$drawDetails['draw_date'].' ' .$drawDetails['draw_time']; ?></td>
                                                <td width="5%"><?php echo $orderData['product_qty']; ?></td>
                                                <td width="15%"><?php echo $orderData['straight_add_on_amount']; ?></td>
                                                <td width="15%"><?php echo $orderData['rumble_add_on_amount']; ?></td>
                                                <td width="15%"><?php echo $orderData['reverse_add_on_amount']; ?></td>
                                                <td width="25%" class="text-right">AED<?php echo number_format($orderData['total_price'],2); ?>
                                                </td>
                                            </tr>
