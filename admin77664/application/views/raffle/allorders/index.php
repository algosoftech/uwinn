...
<div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?=base_url('uwinn_raffle/allraffleorders/exportexcel')?>" method="post" autocomplete="off">
          ...
          <div class="row mt-2">
            ...
            <div class="col-sm-12 col-md-6">
              <div class="form-check">
                <input type="checkbox" name="cancelled_order" id="cancelled_order" class="form-check-input">
                <label class="form-check-label" for="cancelled_order">
