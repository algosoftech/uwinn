          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Raffle Winner List</h5>
              </div>
              <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <form class="" action="<?=getCurrentControllerPath('checkpreview');?>" method="post" enctype="multipart/form-data" >
                        <div class="row">
                          <div class="col-sm-12 col-md-12 col-lg-12">
                            <fieldset>
                              <legend>Raffle Winner </legend>
                              <h6>
                                  Uplaod winner's csv 
                                  <sup>
                                    <a href="<?=fileBaseUrl.'assets/raffle_winners_sample.csv'?>">Sample</a>
                                  </sup>
                                </h6>
                                ...
                                <div class="upload-btn-wrapper">
                                  <button class="uplaod-btn btn btn-sm btn-primary" id="raffle-winner-btn" disabled title="Upload CSV file first" >Check Preview</button>
                                </div>
                                <div class="upload-btn-wrapper">
                          ...
                          <div class="table-responsive">
                            <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                              <thead style="text-align: center;">
                                <tr role="row">
                                  <th width="5%" style="text-align: center;">S.No.  adaf</th>
                                ...
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <td><?=$ALLDATAINFO['created_at'];?></td>
                                    <td style="text-align: right;">
                                      <?php if($ALLDATAINFO['soft_delete'] == 1 ): ?>
                                        <?=showStatus('D')?>
                                      <?php else: ?>
                                        <?=showStatus('A')?> : <?=$ALLDATAINFO['activeStatus']?> <br/>
                                        <?=showStatus('I')?> : <?=$ALLDATAINFO['inactiveStatus']?> 
                                      <?php endif; ?>
                                  </td>
                                  <td>
                                    <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                          <?php if($ALLDATAINFO['status'] == 1): ?>
                                            <a href="<?php echo getCurrentControllerPath('changestatusbatch/'.$ALLDATAINFO['batch_id'].'/0')?>" onClick="return confirm('Do you want to change status');" ><i class="fas fa-thumbs-down"></i>Inactive</a>
                                          <?php elseif($ALLDATAINFO['status'] == 0): ?>
                                            <a href="<?php echo getCurrentControllerPath('changestatusbatch/'.$ALLDATAINFO['batch_id'].'/1')?>" onClick="return confirm('Do you want to change status');"><i class="fas fa-thumbs-up"></i> Active</a>
                                          <?php endif; ?>
                                        </li>
                                        <?php if($ALLDATAINFO['soft_delete'] == 0): ?>
                                          <li> 
                                              <a href="<?php echo getCurrentControllerPath('deletebatchdata/'.$ALLDATAINFO['batch_id'])?>" onClick="return confirm('Do you want to delete');" ><i class="fas fa-trash"></i>Delete</a> 
                                          </li>
                                        <?php endif; ?>
                                      </ul>
                                    </div>
...
<script>
  ...
  $('#daily-dealz-plus').on('change', function(){
    let file = $(this).val();
    $('#raffle-winner-btn').attr('disabled' , false);
  });
