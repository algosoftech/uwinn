            ...
            <div class="row align-items-center">
               <div class="col-md-12">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li class="breadcrumb-item"><a href="<?php echo correctLink('ALLCOLLECTIONPOINTDATA',getCurrentControllerPath('index')); ?>"> Product Request List</a></li>
                     <li class="breadcrumb-item"><a href="javascript:void(0);"><?=$EDITDATA?'Edit':'Add'?> Inventory Quantity</a></li>
                  </ul>
               </div>
            </div>
         </div>
               ...
               <div class="card-body">
                  <div class="basic-login-inner">
                     <form id="currentPageForm" name="currentPageForm" class="form-auth-small" method="post" action="" enctype="multipart/form-data">
                        <input type="hidden" name="CurrentFieldForUnique" id="CurrentFieldForUnique" value="request_id"/>
                        <input type="hidden" name="CurrentIdForUnique" id="CurrentIdForUnique" value="<?=$EDITDATA['request_id']?>"/>
                        <input type="hidden" name="CurrentDataID" id="CurrentDataID" value="<?=$EDITDATA['request_id']?>"/>
                        <input type="hidden" name="inventory_id" id="inventory_id" value="<?=$EDITDATA['inventory_id']?>"/>
                        <input type="hidden" name="collection_point_id" id="collection_point_id" value="<?=$EDITDATA['collection_point_id']?>"/>
                        ...
                        <div class="form-group-inner col-lg-4 col-md-4 col-sm-6 col-xs-12 <?php if(form_error('product')): ?>error<?php endif; ?>">
                           ...
                           <input type="text" list="products_list" name="product" id="product" class="form-control required" value="<?php if(isset($EDITDATA['product_id'])): echo $EDITDATA['product_id'].'|'.$EDITDATA['product_name']; endif; ?>" <?php if(isset($EDITDATA['product_id'])): echo 'readonly'; endif; ?>  placeholder="Enter product Name/Category/Sub Category/Description." />
