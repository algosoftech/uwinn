            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Signup Bonus</a></li>
                    </ul>
                </div>
            </div>
        </div>
                          ...
                          <div class="row" style="margin:0px;">
                            <div class="col-sm-12 col-md-6">
                              <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
                                ...
                                <option value="created_at" <?php if($searchField == 'created_at')echo 'selected="selected"'; ?>>SIGNUP DATE</option>
                                <option value="users_name" <?php if($searchField == 'users_name')echo 'selected="selected"'; ?>>USER NAME</option>
                                <option value="arabian_points" <?php if($searchField == 'arabian_points')echo 'selected="selected"'; ?>>BONUS AMOUNT</option>
                              </select>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                 ...
                                 <div class="table-responsive">
                                    <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                                       ...
                                       <tbody style="text-align: center;">
                                         <?php if($signupBonusData): foreach($signupBonusData as $signupBonus):?>
                                             <tr>
                                                <td><?php echo date('M d, Y h:i A',strtotime($signupBonus['created_at']));?></td>
                                                <td><?php echo stripslashes($signupBonus['users_name']);?></td>
                                                <td><?php echo number_format($signupBonus['arabian_points'],2);?></td>
                                             </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Download Signup Bonus Reports</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?=base_url('campaignsales/signupbonus/exportexcel')?>" method="post" autocomplete="off">
