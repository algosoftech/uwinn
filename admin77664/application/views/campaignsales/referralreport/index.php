            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Referral Report</a></li>
                    </ul>
                </div>
            </div>
        </div>
                          ...
                          <div class="row" style="margin:0px;">
                            <div class="col-sm-12 col-md-6">
                              <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
                                ...
                                <option value="receiver_name" <?php if($searchField == 'receiver_name')echo 'selected="selected"'; ?>>RECEIVER NAME</option>
                                <option value="product_name" <?php if($searchField == 'product_name')echo 'selected="selected"'; ?>>CAMPAIGN NAME</option>
                                <option value="referral_amount" <?php if($searchField == 'referral_amount')echo 'selected="selected"'; ?>>AMOUNT</option>
                                <option value="sender_name" <?php if($searchField == 'sender_name')echo 'selected="selected"'; ?>>SENDER</option>
                              </select>
                            </div>
                            <div class="col-sm-12 col-md-6">
                        ...
                        <div class="col-sm-12">
                                ...
                                <th width="20%">Amount</th>
                                       ...
                                       <tbody style="text-align: center;">
                                         <?php if($ALLDATA <> ""):  foreach($ALLDATA as $referralDataINFO): 
                                         ?>
                                          <tr role="row" class="<?php echo $rowClass; ?>">
                                              <td><?=stripslashes($referralDataINFO['receiver_name'])?></td>
                                              <td><?php echo stripslashes($referralDataINFO['product_name']);?></td>
                                              <td><?php echo number_format($referralDataINFO['referral_amount'],2);?></td>
                                              <td><?php echo stripslashes($referralDataINFO['sender_name']);?></td>
                                          </tr>
                                         <?php endforeach; else: ?>
                                          <tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Download Referral Reports</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?=base_url('campaignsales/referralreport/exportexcel')?>" method="post" autocomplete="off">
