            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Currency Conversion</a></li>
                    </ul>
                </div>
            </div>
        </div>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Manage Currency Conversion</h5>
                ...
                <a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add More</a>
              </div>
              <div class="card-body">
                <form id="Data_Form" name="Data_Form" method="get" action="<?php echo $forAction; ?>">
                  <div class="dt-responsive table-responsive">
                    ...
                    <th width="10%" style="text-align: right;">Status</th>
                      ...
                      <td>
                        <img src="<?=fileBaseUrl.$ALLDATAINFO['image']?>" width="50px">
                      </td>
										  <td><?=stripslashes($ALLDATAINFO['country'])?> (<?=stripslashes($ALLDATAINFO['country_code'])?>)</td>
										  <td><?=stripslashes($ALLDATAINFO['phone_code'])?></td>
										  <td><?=stripslashes($ALLDATAINFO['currency_symbol'])?></td>
										  
                      <!-- <td><?=date('d-M-y h:i A',$ALLDATAINFO['creation_date'])?></td> -->
                      <td>1 AED = <?=number_format($ALLDATAINFO['conversion_rate'],2)?></td>
                      <td style="text-align: right;"><?=showStatus($ALLDATAINFO['status'])?></td>
										  <td>
											<div class="btn-group">
											  <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>
											  <ul class="dropdown-menu" role="menu">
                          <li><a href="<?php echo getCurrentControllerPath('addeditdata/'.$ALLDATAINFO['seq_id'])?>"><i class="fas fa-edit"></i> Edit</a></li>
                          <?php if($ALLDATAINFO['status'] == 'A'): ?>
                            <li><a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['seq_id'].'/I')?>"><i class="fas fa-thumbs-down"></i> Inactive</a></li>
                          <?php elseif($ALLDATAINFO['status'] == 'I' || $ALLDATAINFO['status'] == 'N'): ?>
                            <li><a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['seq_id'].'/A')?>"><i class="fas fa-thumbs-up"></i> Active</a></li>
                          <?php endif; ?>
											   </ul>
											</div>
										  </td>
        ...
        <div class="row mt-2"  style="margin:0px;">
          <div class="col-sm-12 col-md-6">
            <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
              ...
              <option value="user_phone" <?php if($searchField == 'user_phone')echo 'selected="selected"'; ?>>Settler Mobile </option>
            </select>
          </div>
          <div class="col-sm-12 col-md-6">
            <input type="text" name="searchValue" id="searchValue" value="<?php echo $searchValue; ?>" class="form-control form-control-sm" placeholder="Enter Search Text">
      ...
      <form action="<?=getCurrentControllerPath('rejectrequest');?>" method="post" autocomplete="off">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-12">
              <input type="text" name="reason" id="reason" class="form-control form-control-sm" placeholder="Enter reson of rejection">
            </div>
          </div>
        </div>
        <div class="modal-footer">
