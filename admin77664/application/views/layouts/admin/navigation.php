<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
  ...
  <div class="collapse navbar-collapse">
    <ul class="navbar-nav ml-auto">
      <li class="navigation-name">Welcome <?=sessionData('UW_ADMIN_FIRST_NAME')?></li>
      <li>
        <div class="dropdown drp-user">
          ...
          <div class="dropdown-menu dropdown-menu-right profile-notification">
            <div class="pro-head">
              <img src="<?php echo showCorrectImage(sessionData('UW_ADMIN_IMAGE'),'thumb','profile'); ?>" class="img-radius" alt="User-Profile-Image">
              <span><?php echo stripslashes(sessionData('UW_ADMIN_FIRST_NAME')); ?></span>
            </div>
            <ul class="pro-body">
