                ...
                <ul class="pcoded-submenu">
                    <?php foreach($menuChildData as $menuChildDInfo): ?>
                      <?php if($menuChildDInfo->module_name == 'allrechargeUser'): ?>
                        <li <?php if(strtolower($activeSubMenu) == $menuChildDInfo->module_name):?>class="active"<?php endif; ?>><a href="{FULL_SITE_URL}<?php echo stripslashes($menuDInfo['module_name']); ?>/allrecharge/addeditdata"><?php echo stripslashes($menuChildDInfo->module_display_name); ?></a></li>
                      <?php else: ?>
