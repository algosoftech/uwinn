...
<html>
<head>
    <title>Download Hourly Shop Statement</title>
    <style>
        .container {
            text-align: center;
            background: #fff;
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Export Hourly Shop Excel</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <div class="container">
                            <h1>Download Hourly Shop Statement</h1>
                            <div class="timer-circle">
                                <span id="time">52</span>
                            </div>
                            <p>Thanks! Your hourly shop excel download will start in few seconds...</p>
...
<script>
    ...
    var hourlyGameTitles = <?=json_encode($hourlyGameTitles);?>;
    ...
    function mergeShopRows(rows) {
        ...
        rows.forEach(function(row) {
            ...
            if (!shopMap[key]) {
                ...
                hourlyGameTitles.forEach(function(title) {
    ...
    function getExportFilename() {
        return 'hourly-shop-purchase-report-' + new Date().toISOString().slice(0, 10) + '.xlsx';
    }

    function applyHeaderStyles(ws, headers) {
        var staticHeaders = ['POS', 'SHOP NAME', 'Region', 'Supervisor'];
        var hourlyColors = { 'HOURLY 3': 'FF66CC', 'HOURLY 4': '92D050', 'HOURLY 5': '92D050', 'HOURLY 6': 'FF1493' };
        ...
        headers.forEach(function(header, index) {
            ...
            if (staticHeaders.indexOf(header) === -1) {
                bgColor = hourlyColors[String(header).toUpperCase()] || productColors[(index - 4) % productColors.length];
                fontColor = '000000';
            }
    ...
    function downloadClientExcel(data, filename) {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'Hourly Shop Purchase');
    ...
    function finishExport() {
        ...
        try {
            downloadClientExcel(exportData, getExportFilename());
        } catch (err) {
