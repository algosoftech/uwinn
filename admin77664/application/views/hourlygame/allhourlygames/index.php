                            ...
                            <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                              ...
                              <tbody style="text-align: center;">
                                ...
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <td> <?=$ALLDATAINFO['products_id'];?></td>
                                  <td><?=stripslashes($ALLDATAINFO['title'])?></td>
                                  <td><?= date('d F Y',$ALLDATAINFO['creation_date'])?></td>
                                  <td><?= date('d F Y H:i',$ALLDATAINFO['expiry_date'])?></td>
                                  ...
                                  <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                      <li><a href="<?php echo getCurrentControllerPath('addeditdata/'.$ALLDATAINFO['_id']->{'$id'})?>">
                                          <i class="fas fa-edit"></i> Edit Details
                                        </a>
                                      </li>
                                      <li>
                                        <a href="<?php echo getCurrentControllerPath('settings/'.$ALLDATAINFO['_id']->{'$id'})?>">
                                      ...
                                      <?php if($ALLDATAINFO['status'] == 'A'): ?>
                                        <li>
                                          <a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['_id']->{'$id'}.'/I')?>" onclick="return confirm('Are you sure you want to inactive this game?')">
                                            <i class="fas fa-thumbs-down"></i> Inactive
                                          </a>
                                        </li>
                                      <?php elseif($ALLDATAINFO['status'] == 'I'): ?>
                                        <li>
                                          <a href="<?php echo getCurrentControllerPath('changestatus/'.$ALLDATAINFO['_id']->{'$id'}.'/A')?>" onclick="return confirm('Are you sure you want to active this game?')">
