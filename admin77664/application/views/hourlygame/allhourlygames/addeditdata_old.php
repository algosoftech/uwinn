                        ...
                        <div class="basic-login-inner">
                            <form id="currentPageForm" name="currentPageForm" class="form-auth-small" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group-inner col-lg-2 col-md-2 col-sm-2 col-xs-12 <?php if(form_error('game_type')): ?>error<?php endif; ?>">
                                        <label>Game Type<span class="required">*</span></label>
                                        <input type="number" name="game_type" id="game_type" class="form-control required" value="<?php if(set_value('game_type')): echo set_value('game_type'); else: echo stripslashes($EDITDATA['game_type']);endif; ?>">
                                    ...
                                    <div class="form-group-inner col-lg-2 col-md-2 col-sm-2 col-xs-12 <?php if(form_error('game_type')): ?>error<?php endif; ?>">
                                        <label>Coupon Selection Type<span class="required">*</span></label>
                                        <select name="coupon_selection_type" id="coupon_selection_type" class="form-control required">
                                            <option value="">Select</option>
                                            <option value="auto"   <?=$EDITDATA['coupon_selection_type'] == 'auto' ? 'selected':''; ?> >Auto</option>
                                            <option value="random" <?=$EDITDATA['coupon_selection_type'] == 'random' ? 'selected':''; ?> >Random</option>
                                            <option value="manual" <?=$EDITDATA['coupon_selection_type'] == 'manual' ? 'selected':''; ?> >Manual</option>
                                        </select>
                                        <?php if(form_error('coupon_selection_type')): ?>
                                            <span for="coupon_selection_type" generated="true" class="help-inline"><?php echo form_error('coupon_selection_type'); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    
                                    <div class="form-group-inner col-lg-2 col-md-2 col-sm-2 col-xs-12 <?php if(form_error('number_repeat')): ?>error<?php endif; ?>">
                                        <label>Number Repeating<span class="required">*</span></label>
                                        <select name="number_repeat" id="number_repeat" class="form-control required">
                                            <?php if(stripslashes($EDITDATA['number_repeat']) == 'Y'): ?>
                                        ...
                                        <?php if(form_error('number_repeat')): ?>
                                         <span for="number_repeat" generated="true" class="help-inline">
                                            <?php echo form_error('number_repeat'); ?>
                                        </span>
                                        <?php endif; ?>
                                    </div>
                                     
                                    <div class="form-group-inner col-lg-2 col-md-2 col-sm-2 col-xs-12 <?php if(form_error('number_range_start')): ?>error<?php endif; ?>">
                                        <label>Number Range Start<span class="required">*</span></label>
                                        <input type="number" min="0"  max="100" name="number_range_start" id="number_range_start" class="form-control required" value="<?php if(set_value('number_range_start')): echo set_value('number_range_start'); elseif($EDITDATA['number_range_start'] == 0): echo '0';  else: echo $EDITDATA['number_range_start']; endif; ?>" >
                                        <div class="range-section"></div>
                                        <?php if(form_error('number_range_start')): ?>
                                            <span for="number_range_start" generated="true" class="help-inline"><?php echo form_error('number_range_start'); ?></span>
                                        <?php endif; ?>
                                    </div>

                                    <div class="form-group-inner col-lg-2 col-md-2 col-sm-2 col-xs-12 <?php if(form_error('number_range_end')): ?>error<?php endif; ?>">
                                        <label>Number Range End<span class="required">*</span></label>
                                        <input type="number" min="1"  max="100" name="number_range_end" id="number_range_end" class="form-control required" value="<?php if(set_value('number_range_end')): echo set_value('number_range_end'); elseif($EDITDATA['number_range_end']): echo stripslashes($EDITDATA['number_range_end']); endif; ?>" >
                                        <div class="range-section"></div>
                                        <?php if(form_error('number_range_end')): ?>
                                            <span for="number_range_end" generated="true" class="help-inline"><?php echo form_error('number_range_end'); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="form-group-inner col-lg-2 col-md-2 col-sm-2 col-xs-12 <?php if(form_error('start_date')): ?>error<?php endif; ?>">
                                        ...
                                        <input type="datetime-local" name="start_date" id="start_date" class="form-control required" value="<?php if(set_value('start_date')): echo set_value('start_date'); else:  echo $start_date;endif; ?>">
                                    ...
                                    <div class="form-group-inner col-lg-2 col-md-2 col-sm-2 col-xs-12 <?php if(form_error('expiry_date')): ?>error<?php endif; ?>">
                                        ...
                                        <input type="datetime-local" name="expiry_date" id="expiry_date" class="form-control required" value="<?php if(set_value('expiry_date')): echo set_value('expiry_date'); else:  echo $expiry_date;endif; ?>">
