  ...
  <div class="modal-dialog" role="document">
    <DIV class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="shopExportModalLabel">Download Shop Excel</h5>
          ...
          <?php if($ALLPRODUCT <> ""): foreach($ALLPRODUCT as $ALLPRODUCTINFO): ?>
            <div class="col-sm-12 col-md-6">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="productIds[]" value="<?=$ALLPRODUCTINFO['products_id']?>" id="shop_product_<?=$ALLPRODUCTINFO['products_id']?>">
                <label class="form-check-label" for="shop_product_<?=$ALLPRODUCTINFO['products_id']?>"><?=$ALLPRODUCTINFO['title']?></label>
              </div>
            </div>
