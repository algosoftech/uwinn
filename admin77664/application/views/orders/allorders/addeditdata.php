                                ...
                                <div class="col-sm-12 col-sm-offset-12">
                                    <table style="width: 100%">
                                        <thead>
                                            ...
                                            <?php if($orderData['ticket_updated_at']): ?>
                                            <tr>
                                                <td class="text-left" colspan="7"><span class="order-deatils">Coupons updated :</span>
                                                    <?=date("Y-m-d H:i",strtotime($orderData['ticket_updated_at']));?>
                                                </td>
                                            </tr>
                                            <?php endif; ?>
