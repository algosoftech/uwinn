...
<script>
    ...
    var bindWithAdmin     = <?=json_encode($bindWithAdmin);?>;
    ...
    function GETDATA() {
        if (currentPage <= totalPage) {
            $.ajax({
                ...
                type: 'POST',
                data: { pageno: currentPage, searchField: searchField, searchValue: searchValue, fromDate: fromDate, toDate: toDate , bindWithAdmin : bindWithAdmin },
                success: function(data) {
                    ...
                    if (responsesReceived == totalPage) {
                        ...
                        const filename = 'RECHARGE TOP-UP HISTORY-' + curdate + '.xlsx';
