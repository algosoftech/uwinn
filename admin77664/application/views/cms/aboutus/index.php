          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <?php if($ALLDATA == ""): ?><a href="<?php echo getCurrentControllerPath('addeditdata'); ?>" class="btn btn-sm btn-primary pull-right">Add</a><?php  endif; ?>
              </div>
              <div class="card-body">
                            ...
                            <tbody style="text-align: center;">
                              ...
                              ?>
                                <tr role="row" class="<?php echo $rowClass; ?>">
                                  ...
                                  <td>
                                    <?php foreach($ALLDATAINFO['sections'] as $key => $IteamArray): $Sno = $key +1;  
                                      if($IteamArray->title):
                                        echo $Sno.") ". $IteamArray->title;
                                      endif;
                                    endforeach;?>
                                  </td>
                                  <td>
