                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                          <li class="breadcrumb-item"><a href="{FULL_SITE_URL}dashboard"><i class="feather icon-home"></i></a></li>
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo correctLink('CMSCANCELLATIONPOLICY',getCurrentControllerPath('index')); ?>">Users Agreement Policy</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);"><?=$EDITDATA?'Edit':'Add'?> Users Agreement</a></li>
                        </ul>
                    </div>
                </div>
            </div>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5><?=$EDITDATA?'Edit':'Add'?> Users Agreement</h5>
              ...
              <div class="card-body">
                <div class="basic-login-inner">
                  <form id="currentPageForm" name="currentPageForm" class="form-auth-small" method="post" action="" enctype="multipart/form-data">
                    <input type="hidden" name="CurrentFieldForUnique" id="CurrentFieldForUnique" value="usersagreement_id"/>
                    <input type="hidden" name="CurrentIdForUnique" id="CurrentIdForUnique" value="<?=$EDITDATA['usersagreement_id']?>"/>
                    <input type="hidden" name="CurrentDataID" id="CurrentDataID" value="<?=$EDITDATA['usersagreement_id']?>"/>
