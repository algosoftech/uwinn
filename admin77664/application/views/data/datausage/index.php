            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Data Usage</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                  ...
                  <tbody style="text-align: center;">
                    ...
                    <tr role="row" class="<?php echo $rowClass; ?>">
                      ...
                      <td><?=$ALLDATAINFO['current_datamode'];?></td>
                      <td>
                      <?php
                        if($ALLDATAINFO['current_datamode'] == 'WiFi'):
                        echo number_format($ALLDATAINFO['wifi_usage'],2);
                        else:
                        echo number_format($ALLDATAINFO['mobile_data_usage'],2);
                        endif;
                      ?>   
                      </td>
