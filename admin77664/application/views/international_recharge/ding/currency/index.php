                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-md-3">
                                            <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
                                                ...
                                                <option value="CurrencyIso" <?php if ($searchField == 'CurrencyIso') echo 'selected="selected"'; ?>>Currency ISO</option>
                                                <option value="CurrencyName" <?php if ($searchField == 'CurrencyName') echo 'selected="selected"'; ?>>Currency Name</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-3 col-md-3">
                                                ...
                                                if (!empty($ALLDATA)):
                                                    ...
                                                    foreach ($ALLDATA as $row): $rowClass = ($j % 2 == 0) ? 'odd' : 'even'; ?>
                                                        <tr role="row" class="<?php echo $rowClass; ?>">
                                                            ...
                                                            <td><?php echo $i++; ?></td>
                                                            <td><?php echo $row['CurrencyIso']; ?></td>
