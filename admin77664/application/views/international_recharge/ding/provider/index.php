                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-md-3">
                                            <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
                                                ...
                                                <option value="Name" <?php if ($searchField == 'Name') echo 'selected="selected"'; ?>>Provider Name</option>
                                                <option value="CustomerCareNumber" <?php if ($searchField == 'CustomerCareNumber') echo 'selected="selected"'; ?>>Customer Care Number</option>
                                        ...
                                        <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                                            <thead style="text-align: center;">
                                                <tr role="row">
                                                    <th width="5%">S.No.</th>
                                                    <th width="15%">Logo</th>
                                                    <th width="15%">Provider Code</th>
                                                    <th width="15%">Provider Name</th>
                                                    <th width="15%">Customer Care Number</th>
                                                    <th width="15%">Country ISO</th>
                                                    <th width="15%">Payment Types</th>
                                                ...
                                                if (!empty($ALLDATA)):
                                                    ...
                                                    foreach ($ALLDATA as $row): $rowClass = ($j % 2 == 0) ? 'odd' : 'even'; ?>
                                                        <tr role="row" class="<?php echo $rowClass; ?>">
                                                            ...
                                                            <td><?php echo $i++; ?></td>
                                                            <td>
                                                                <img src="<?php echo $row['LogoUrl']; ?>" alt="<?php echo $row['Name']; ?>" width="100" height="100">
                                                            </td>
                                                            <td><?=$row['Name']; ?></td>
                                                            <td><?=$row['ProviderCode']??'N/A'; ?></td>
                                                            <td><?=$row['CustomerCareNumber']??'N/A'; ?></td>
                                                            <td><?=$row['CountryIso']??'N/A'; ?></td>
                                                            <td><?=implode(', ', $row['PaymentTypes']); ?></td>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <li>
                                                                        <a href="<?php echo getCurrentControllerPath('addeditdata/'.$row['_id']->{'$id'})?>" onclick="return confirm('Are you sure you want to edit this provider?')"> <i class="fas fa-edit"></i> Edit</a>
                                                                    </li>
                                                                    <?php if($row['status'] == 'A'): ?>
                                                                    <li>
                                                                        <a href="<?php echo getCurrentControllerPath('changestatus/'.$row['_id']->{'$id'}.'/I')?>" onclick="return confirm('Are you sure you want to update the status of this provider?')"> <i class="fas fa-thumbs-down"></i> Inactive</a>
                                                                        </a>
                                                                    </li>
                                                                    <?php elseif($row['status'] == 'I'): ?>
                                                                    <li>
                                                                        <a href="<?php echo getCurrentControllerPath('changestatus/'.$row['_id']->{'$id'}.'/A')?>" onclick="return confirm('Are you sure you want to update the status of this provider?')"> <i class="fas fa-thumbs-up"></i> Active</a>
                                                                    </li>
                                                                    <?php endif; ?>
                                                                    </ul>
                                                                </div>
