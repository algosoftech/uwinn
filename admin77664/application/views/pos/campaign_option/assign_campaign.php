                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-login-inner">
                            <fieldset>
                                <legend>Select POS Device (Option 1)</legend>
                            ...
                            <fieldset>
                                <legend>Select Web Campaign</legend>
                                             ...
                                             <div class="col-lg-4 col-md-6 col-sm-6 form-group-inner">
                                                <div class="campaign-section">
                                                    ...
                                                    <div class="camoaign-details">
                                                       ...
                                                       <p> 
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="selected_web_campaign_list[]" value="<?=$items['products_id'];?>" id="selected_web_campaign_list<?=$key;?>"
                                                           <?php if($selectedCampaign['selected_web_campaign_list']):  if(in_array($items['products_id'],$selectedCampaign['selected_web_campaign_list'])): echo "checked"; endif; endif; ?>>
                                                          <label class="form-check-label" for="selected_web_campaign_list<?=$key;?>">Assign</label>
                                                        </div>
                                                    </div>
                                                </div>
                                             </div>
                            ...
                            <fieldset>
                                <legend>Select App Campaign</legend>
                                <input type="hidden" name="CurrentFieldForUnique" id="CurrentFieldForUnique" value="campaign_id"/>
                                <input type="hidden" name="CurrentIdForUnique" id="CurrentIdForUnique" value="<?=$selectedCampaign['campaign_id']?>"/>
                                <input type="hidden" name="CurrentDataID" id="CurrentDataID" value="<?=$selectedCampaign['campaign_id']?>"/>
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                             ...
                                             <div class="col-lg-4 col-md-6 col-sm-6 form-group-inner">
                                                <div class="campaign-section">
                                                    ...
                                                    <div class="camoaign-details">
                                                       ...
                                                       <p> 
                                                        <div class="form-check">
                                                          <input class="form-check-input" type="checkbox" name="selected_app_campaign_list[]" value="<?=$items['products_id'];?>" id="selected_app_campaign_list<?=$key;?>"
                                                           <?php if($selectedCampaign['selected_app_campaign_list']):  if(in_array($items['products_id'],$selectedCampaign['selected_app_campaign_list'])): echo "checked"; endif; endif; ?>>
                                                          <label class="form-check-label" for="selected_app_campaign_list<?=$key;?>">Assign</label>
                                                        </div>
                                                    </div>
                                                </div>
                                             </div>
