                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo getCurrentControllerPath('index'); ?>">Orders</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row align-items-center mb-2">
                                        <div class="col-sm-3 col-md-2">
                                            <select name="searchField" id="searchField" class="custom-select custom-select-sm form-control form-control-sm">
                                                ...
                                                <option value="winning_status" <?php if ($searchField == 'winning_status') echo 'selected="selected"'; ?>>Winning Status (Y/N)</option>
                                        ...
                                        <table id="simpletable" class="table table-striped table-bordered nowrap dataTable" role="grid" aria-describedby="simpletable_info">
                                            <thead style="text-align: center;">
                                                <tr role="row">
                                                    ...
                                                    <th width="12%">Winning Details</th>
                                            ...
                                            <tbody style="text-align: center;">
                                                ...
                                                <tr role="row" class="<?php echo $rowClass; ?>">
                                                    ...
                                                    <td class="text-left">
                                                        ...
                                                        <b>Email</b>: <?php echo htmlspecialchars($row['buyer_email'] ?? 'N/A'); ?><br/>
                                                        <b>SMS</b>: <?php echo htmlspecialchars($row['sms_type'] ?? 'N/A'); ?>
                                                    </td>
                                                    <td class="text-left">
                                                        <b>Status</b>: <?php echo htmlspecialchars($row['winning_status'] ?? 'N'); ?>
                                                    </td>
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="10" style="text-align:center;">No Scratch Win orders found.</td>
                                                </tr>
                                                <?php endif; ?>
                                            </tbody>
                                        </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exportModalLabel">Download Order Reports</h5>
