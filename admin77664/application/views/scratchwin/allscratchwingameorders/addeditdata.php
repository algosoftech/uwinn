...
$orderOid = !empty($order['_id']->{'$id'}) ? $order['_id']->{'$id'} : '';
?>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo getCurrentControllerPath('index'); ?>">Scratch Win Orders</a></li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Order Details - <?php echo htmlspecialchars($order['order_id'] ?? 'N/A'); ?></h5>
                        <a href="<?php echo correctLink('ALLSCRATCHWINGAMEORDERSDATA', getCurrentControllerPath('index')); ?>" class="btn btn-sm btn-secondary pull-right">Back</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered table-sm">
                                    <tr><th width="40%">Winning Status</th><td><?php echo htmlspecialchars($order['winning_status'] ?? 'N'); ?></td></tr>
