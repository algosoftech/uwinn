                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?=correctLink('ALLSALESDATA',getCurrentControllerPath('users/allusers/index')); ?>"> User</a>
                            </li>
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0);"><?=$EDITDATA?'Edit':'Add'?> User</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <form id="currentPageForm" name="currentPageForm" class="form-auth-small" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group-inner col-lg-6 col-md-6 col-sm-6 col-xs-12 <?php if(form_error('redeeming_amount_limit')): ?>error<?php endif; ?>">
                                        <label>Redeeming Amount Limit</label>
                                        <input type="text" name="redeeming_amount_limit" id="redeeming_amount_limit" class="form-control" value="<?php if(set_value('redeeming_amount_limit')): echo set_value('redeeming_amount_limit'); else: echo stripslashes($EDITDATA['redeeming_amount_limit']);endif; ?>" placeholder="Redeeming Amount Limit">
                                        <?php if(form_error('redeeming_amount_limit')): ?>
                                        <span for="name" generated="true" class="help-inline"><?php echo form_error('redeeming_amount_limit'); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="row">
