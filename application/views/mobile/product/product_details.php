<div class="result_list" id="game_play">
    <div class=" mx-0">
        <div class="main_banner">
            
            <div class="timer countdown" id="countdown" data-drawDate='<?=$ourCampaigns['draw_date'].' '.$ourCampaigns['draw_time']; ?>'>
                <p> 
                ...
                <p> 
                    <span class="timer-shw" id="hours"></span>
                     <span class="web-week">HRS</span>
                </p> 
                  
                <p> 
                    <span class="timer-shw" id="minutes"></span>  
                    <span class="web-week">MINS</span>
                </p> 
                    
                <p> 
                    <span class="timer-shw" id="seconds"></span>  
                    <span class="web-week">SECS</span>
                </p>
            </div>

            <div class="row inner_contentmainbanner">
                <div class="col-4">
                    <div class="product_img">
                        <a href="javascript:void(0);" class="list_dots" data-pid="product-detail">
                            <img src="<?=ImageExist($ourCampaigns['product_image']);?>" alt="<?=$ourCampaigns['product_image_alt'];?>">
                        </a>
                    </div>
                </div>
                <div class="col-7">
                    <div class="home_list">
                            <p class="product_title"><?=$ourCampaigns['title'];?></p>
                        <div class="price-section-container">
                            <p class="price_amount_lable mt-3">Get your chance of</p>
                            <p class="price_amount">
                                <?php if(!empty($ourCampaigns['lotto_type'])): ?>
                                   <?php $prizeAmount = $ourCampaigns['prize_stright'.$ourCampaigns['lotto_type']]; ?>
                                   <i class="amount"> <?=number_format($prizeAmount);?></i>
                                <?php endif; ?>
                            </p>
                ...
                <div class="col-1">
                    <a href="javascript:void(0)" title="campaign details" class="list_dots product-detail-page"> 
                        <i class="bi bi-info-circle-fill info-icon list_dots" data-pid="product-detail" ></i>
                    </a>
                </div>
            </div>
            <!-- product detail section start -->
            <div class="row campaign-detail-container product-detail d-none">
                <div class="col-12">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="product<?=$key;?>">
                                            <div class="product_history">
                                                <h2><?=$ourCampaigns['title'];?></h2>
                                                <img src="<?=ImageExist($ourCampaigns['product_image']);?>" alt="<?=$ourCampaigns['product_image_alt'];?>">
                                                <?php /* product description */ ?>
                                                <?=$ourCampaigns['description'];?>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="prize<?=$key;?>">
                                            <div class="cardbox mb-4">
                                                ...
                                                <ul>
                                                    <?php if($ourCampaigns['prize_enable_title'] == "Y"):?>
                                                        <li>
                                                            <span> Prize Amount </span>
                                                            <strong> <?=$ourCampaigns['prize_title'];?></strong>
                                                        </li>
                                                    <?php endif; ?>

                                                    <?php if($ourCampaigns['prize_enable_stright_prize_heading'] == "Y"):?>
                                                        <li>
                                                            <span>Sharing grand</span>
                                                            <strong> <?=$ourCampaigns['prize_stright_prize_heading'];?></strong>
                                                        </li>
                                                    <?php endif; ?>

                                                    <?php if($ourCampaigns['prize_enable_rumble_mix_prize_heading'] == "Y"):?>
                                                        <li>
                                                            <span>Multiple win</span>
                                                            <strong> <?=$ourCampaigns['prize_rumble_mix_prize_heading'];?></strong>
                                                        </li>
                                                    <?php endif; ?>

                                                    <?php if($ourCampaigns['prize_enable_reverse_prize_heading'] == "Y"):?>
                                                        <li>
                                                            <span>cash back</span>
                                                            <strong> <?=$ourCampaigns['prize_reverse_prize_heading'];?></strong>
                                                        </li>
                                                    <?php endif; ?>
            ...
            <div class="Raffle_no">
                <h1>Choose your favorite <br> Raffle Number</h1>
                ...
                <div class="product_summry">
                    <div class="product_summry_in">
                        <div class="tickect-section">
                            <div class="product_summry_row ticket_1 selected">
                                <strong>1</strong>
                            ...
                            <div  class="ticket_1" <?php if($productSetting['straight_settings'] != 'Enable' && $productSetting['rumble_settings'] != 'Enable' && $productSetting['reverse_settings'] != 'Enable'): ?> style="display: none;" <?php endif;?>>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','#increase', function() {
            ...
            if(AddTicket == "Y"){
                    ...
                    if(QTY == 10){
                        alertMessageModelPopup('Max Ticket adding limit reached.','danger')
                        return false;
                    }
                    ...
                    if ($(`.ticket_${newQty}`).length === 0) {
                        ...
                        $(".product_summry_in").prepend(`
                            <div class="tickect-section">
                                <div class="ticket_row product_summry_row ticket_${duplicate_newQTY} selected">
                                    <strong>${newQty}</strong>
                                    <div class="product_summrynum">${spanElements}</div>
