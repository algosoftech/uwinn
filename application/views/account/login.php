                    ...
                    <div class="contact_form form">
                        ...
                        <form method="post" action="#" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="password" name="password" id="password" value="<?php echo set_value('password'); ?>" placeholder="Confirm password*" class="form-control"  />
                                    </div>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group text-center">
                                        <div class="text-right w-100 mb-2">
                                            <a href="<?=base_url('forgot-password');?>" class="forget_password">Forgot Password</a>
                                        </div>
