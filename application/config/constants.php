...
defined('MAIL_FROM_MAIL')      OR define('MAIL_FROM_MAIL', 'info@u-winn.com'); 
defined('MAIL_SITE_FULL_NAME') OR define('MAIL_SITE_FULL_NAME', 'U Winn'); 
 
defined('SENDGRID_KEY') 	   OR define('SENDGRID_KEY', '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'); 
...
if($_SERVER['SERVER_NAME']=='localhost'):
	...
	defined('MAIN_URL')     			OR 	define('MAIN_URL','http://'.$_SERVER['HTTP_HOST'].'/u-winn/');
	$fileBaseUrl 						=	'http://'.$_SERVER['HTTP_HOST'].'/u-winn/';
	$fileFCPATH 						=	$_SERVER['DOCUMENT_ROOT'].'/u-winn/';

	$baseUrlForWebview					=	'http://'.$_SERVER['HTTP_HOST'].'/u-winnn/';
	$baseUrlForCommonWeb				=	'http://'.$_SERVER['HTTP_HOST'].'/u-winnn/';
///////////// 	/////////////////	
else: 
...
defined('MERCHENT_IDENTIFIER')  OR 	define('MERCHENT_IDENTIFIER','acct_1R7ExDHq8ojwu8I8');

//merchantIdentifier
defined('STRIPE_TEST_SK')		OR 	define('STRIPE_TEST_SK','sk_test_51R7ExQHKfZlnTADpz0MORNjWEN8TOThexwIovhjb4N8IbXB3hJYXC2QIC7ilhhDPNC7npv0depprD5feGilfIjaC00vdGmIjqW');
...
// LIVE CREDIENTIALS..
defined('STRIPE_LIVE_SK')		OR 	define('STRIPE_LIVE_SK','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');
