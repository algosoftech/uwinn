	...
	{	
		...
		if(requestAuthenticate(APIKEY,'GET')):
			...
			if($this->input->get('users_id') == ''): 
				...
				$Fieldslist     = array(
					'users_type','users_name','last_name','users_email','country_code','users_mobile','pickup_point_holder','area','commission_percentage','store_name',
					...
					'enable_raffle_entries','otp_generated_at','summarypin_verified_at','enable_summary_otp','enable_tambola_games','enable_hourly_games','show_lotto_campaign','availableReachargePoints','enable_ding','ding_commission_percentage'
				);
				$tblName 		= 'uw_users';
